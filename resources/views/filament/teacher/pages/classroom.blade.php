<x-filament-panels::page>
    ...
    <x-filament::modal id="group-level-up" >
        @if($modalModel)
            <!-- Card Header -->
            <div class="p-4 border-b">
                <div class="text-center font-semibold text-xl text-gray-800">
                    {{ __('teacher.Group') . ' ' . $modalModel->name }}
                </div>
            </div>
            ...
            <!-- Congratulations message -->
            <div class="text-center font-semibold text-xl text-gray-800">
                {{ __('teacher.CongratulationsLevelUpGroup') . ' ' . $modalModel->level . '!' }}
            </div>
    ...
    <div class="mb-5 px-4  bg-white p-4 rounded-xl">
        <div class="p-4 border-b">
            <div class="text-center font-semibold text-xl text-gray-800">
        ...
        @empty
            @foreach($groups as $group)
                    ...
                    <div class="mb-4 px-4 col-span-full">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-3  dark:bg-gray-700">
                            <div class="bg-primary-500 h-3 rounded-full" style="width: {{ $group->levelProgress }}%"></div>
                            <div class="text-center font-semibold text-sm text-gray-800">
                                {{ __('teacher.Level') . ' ' . $group->level }}
                            </div>
                        </div>
                    </div>
